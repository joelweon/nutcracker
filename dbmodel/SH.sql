...
insert into rev_phot(rpno,rvno,path) values(251,201,'reviw01.jpg');
insert into rev_phot(rpno,rvno,path) values(252,202,'reviw01.jpg');
insert into rev_phot(rpno,rvno,path) values(253,203,'reviw01.jpg');
insert into rev_phot(rpno,rvno,path) values(254,204,'reviw01.jpg');
insert into rev_phot(rpno,rvno,path) values(255,205,'reviw01.jpg');
insert into rev_phot(rpno,rvno,path) values(256,206,'reviw01.jpg');
insert into rev_phot(rpno,rvno,path) values(257,207,'reviw01.jpg');
insert into rev_phot(rpno,rvno,path) values(258,208,'reviw01.jpg');
insert into rev_phot(rpno,rvno,path) values(259,209,'reviw01.jpg');
insert into rev_phot(rpno,rvno,path) values(260,210,'reviw01.jpg');