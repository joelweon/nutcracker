...
-- 3. WISH
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(100,2,'남해수산 건미역 1kg','남해 수산','11680','wish01.jpg','http://www.nhmarket.kr/goods/content.asp?guid=2545297&cate=1105');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(101,2,'미역줄기볶음(200g)','몽촌반찬','2700','wish02.jpg','http://www.mcfood.net/shop/shopdetail.html?branduid=20&search=%25B9%25CC%25BF%25AA%25C1%25D9%25B1%25E2&sort=&xcode=002&mcode=002&scode=001&GfDT=bmt1W1w%3D');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(102,3,'[청하간장게장] 간장게장','청하간장게장','78000','wish03.jpg','http://chcrab.com/product/detail.html?product_no=17&cate_no=42&display_group=1');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(103,4,'광천 토굴 새우젓 1kg','맛군','14900','wish04.jpg','http://storefarm.naver.com/mggfood/products/252141825?NaPm=ct%3Diz93e63c%7Cci%3Dad8dad47f7e7955e83700f11816315ecf5981477%7Ctr%3Dslsl%7Csn%3D239741%7Cic%3D%7Chk%3Dfe404dc97a53be168dfc92b20977f95a83772357');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(104,4,'쇼파패드 3인용 4인용','부창인터내셔널','26800','wish05.jpg','http://storefarm.naver.com/contradnaz81/products/495758463?NaPm=ct%3Diz93jvc8%7Cci%3D9e75c561710c676eeeadb3990cdc43953e08297f%7Ctr%3Dslsl%7Csn%3D392126%7Cic%3D%7Chk%3D53b70a384500c4126fa907707bf341508fd24b54');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(105,4,'스위스밀리터리 스텐 보온도시락 470ml','스위스밀리터리','26900','wish06.jpg','http://storefarm.naver.com/nicemom/products/304575463');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(106,4,'이롬 황성주 국산콩 두유 190mlX16팩','이롬','7280','wish07.jpg','http://daisomall.co.kr/shop/goods_view.php?id=0001106871&ad_code=naver_shopping&NaPm=ct%3Diz94e8pc%7Cci%3D3a780b5d01b51c5b891ef42af857f93da639d3d4%7Ctr%3Dslc%7Csn%3D413413%7Chk%3D2cd92517a6ff0fb8296fdba1684a1435b78232be');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(107,5,'이든타운 오트밀 식사용 5kg','이든타운에프엔비','25500','wish08.jpg','http://storefarm.naver.com/intofood/products/101415053?NaPm=ct%3Diz94gzgw%7Cci%3De2ba07479c7dd6eca1b175aac0e4e1ffd8538dc9%7Ctr%3Dslc%7Csn%3D165363%7Cic%3D%7Chk%3D82b0c887ec06d2dda7914ac4db15bb3f7ee99c5e');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(108,6,'국내산 녹미원 참 생와사비 100g','녹미원','3400','wish09.jpg','http://storefarm.naver.com/goodsea/products/385656474?NaPm=ct%3Diz94kfp4%7Cci%3Ddd6a088c62f1d457ce5611812ca8ef702f67cdbd%7Ctr%3Dslsl%7Csn%3D273056%7Cic%3D%7Chk%3D9686c094a88aad79b39b248fa09f821bb276b856');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(109,6,'데체코 바질페스토 200g','데체코','5850','wish10.jpg','http://itempage3.auction.co.kr/DetailView.aspx?ItemNo=B238238231&frm3=V2');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(110,7,'덴마크 인포켓치즈 200G(20G*10입)','(주)동원데어리푸드','9900','wish11.jpg','http://www.lottesuper.co.kr/handler/goods/GoodsDetail?goods_no=1247660&sale_shop_sct_cd=01&sale_shop_id=&template_type_code=&disp_cat_no=1000300002');
insert into wish(wno,mno,pro_name,pro_comp,price,path,link) values(111,7,'아가프라 매직빨대컵 300ml','아가프라','6700','wish12.jpg','http://storefarm.naver.com/bnpkorea/products/598430082?NaPm=ct%3Diz94y04g%7Cci%3Ddc478cb25cd1ce1bc5abaee99d1c7ba68d8122b4%7Ctr%3Dslc%7Csn%3D445387%7Cic%3D%7Chk%3De7cad63839c92c2c189856290a0cf4095c5be442');

-- 기업정보 -----------------------------------
-- 옥시
insert into comp(cpno,cp_name,parno) 
    values(500,'옥시레킷벤키저',0);
-- 유한
insert into comp(cpno,cp_name,parno) 
    values(501,'유한양행',0);
insert into comp(cpno,cp_name,parno) 
    values(502,'유한킴벌리',501);
insert into comp(cpno,cp_name,parno) 
    values(503,'유한화학',501);
insert into comp(cpno,cp_name,parno) 
    values(504,'유한메디카',501);
insert into comp(cpno,cp_name,parno) 
    values(505,'유한크로락스',501);
insert into comp(cpno,cp_name,parno) 
    values(506,'한국얀센',501);
insert into comp(cpno,cp_name,parno) 
    values(507,'엔솔테크',501);
...
insert into comp(cpno,cp_name,parno) 
    values(510,'신세계',0);
insert into comp(cpno,cp_name,parno) 
    values(511,'신세계건설',510);
insert into comp(cpno,cp_name,parno) 
    values(512,'이마트',510);
insert into comp(cpno,cp_name,parno) 
    values(513,'신세계백화점',510);
insert into comp(cpno,cp_name,parno) 
    values(514,'신세계아이앤씨',510);
insert into comp(cpno,cp_name,parno) 
    values(515,'광주신세계',510);
insert into comp(cpno,cp_name,parno) 
    values(516,'신세계푸드',510);
insert into comp(cpno,cp_name,parno) 
    values(517,'스타벅스코리아',510);
insert into comp(cpno,cp_name,parno) 
    values(518,'신세계인터네셔널',510);
insert into comp(cpno,cp_name,parno) 
    values(519,'조선호텔베이커리',510);
insert into comp(cpno,cp_name,parno) 
    values(520,'신세계조선호텔',510);
insert into comp(cpno,cp_name,parno) 
    values(521,'신세계첼시',510);
-- 아모레퍼시픽
insert into comp(cpno,cp_name,parno) 
    values(522,'아모레퍼시픽',0);
insert into comp(cpno,cp_name,parno) 
...
insert into comp(cpno,cp_name,parno) 
    values(533,'프리메라',522);
insert into comp(cpno,cp_name,parno) 
    values(534,'이니스프리',522);
insert into comp(cpno,cp_name,parno) 
    values(535,'베리떼',522);
insert into comp(cpno,cp_name,parno) 
    values(536,'에뛰드',522);
insert into comp(cpno,cp_name,parno) 
    values(537,'롤리타렘피카향수',522);
insert into comp(cpno,cp_name,parno) 
    values(538,'에스쁘아',522);
insert into comp(cpno,cp_name,parno) 
    values(539,'려',522);
...
insert into comp(cpno,cp_name,parno) 
    values(560,'너브',558);
insert into comp(cpno,cp_name,parno) 
    values(561,'I-Shoplog',558);
insert into comp(cpno,cp_name,parno) 
    values(562,'원더홀딩스',558);
-- 매일유업
insert into comp(cpno,cp_name,parno) 
    values(563,'매일유업',0);
insert into comp(cpno,cp_name,parno) 
    values(564,'엠즈씨드',563);
insert into comp(cpno,cp_name,parno) 
    values(565,'레뱅드매일',563);
insert into comp(cpno,cp_name,parno) 
    values(566,'본만제',563);
insert into comp(cpno,cp_name,parno) 
    values(567,'엠즈베버리지',563);
insert into comp(cpno,cp_name,parno) 
    values(568,'엠즈푸드시스템',563);
insert into comp(cpno,cp_name,parno) 
    values(569,'상하농원',563);
insert into comp(cpno,cp_name,parno) 
    values(570,'코리아후드써비스',563);
-- 남양유업
insert into comp(cpno,cp_name,parno) 
    values(571,'남양유업',0);
-- lg
insert into comp(cpno,cp_name,parno) 
    values(572,'LG',0);
insert into comp(cpno,cp_name,parno) 
    values(573,'LG디스플레이',572);
insert into comp(cpno,cp_name,parno) 
    values(574,'LG이노텍',572);
insert into comp(cpno,cp_name,parno) 
    values(575,'이노싱크',572);
insert into comp(cpno,cp_name,parno) 
    values(576,'하이로지스틱스',572);
insert into comp(cpno,cp_name,parno) 
    values(577,'씨텍',572);
insert into comp(cpno,cp_name,parno) 
    values(578,'코카콜라음료',572);
insert into comp(cpno,cp_name,parno) 
    values(579,'해태HTB',572);
insert into comp(cpno,cp_name,parno) 
    values(580,'더페이스샵',572);
insert into comp(cpno,cp_name,parno) 
    values(581,'LG-TOSTEM',572);
insert into comp(cpno,cp_name,parno) 
    values(582,'LG경제연구원',572);
-- 몽드드
insert into comp(cpno,cp_name,parno) 
    values(583,'몽드드',0);
-- 동서식품
...
insert into comp(cpno,cp_name,parno) 
    values(595,'엔디에스',588);
insert into comp(cpno,cp_name,parno) 
    values(596,'농심캐피탈',588);
insert into comp(cpno,cp_name,parno) 
    values(597,'농심엔지니어링',588);
...
-- insert into cmt_rep(ctno,mno,rwno) values(619,11,703);
-- insert into cmt_rep(ctno,mno,rwno) values(631,3,704);
-- insert into cmt_rep(ctno,mno,rwno) values(632,4,705);
-- insert into cmt_rep(ctno,mno,rwno) values(643,5,706);
-- insert into cmt_rep(ctno,mno,rwno) values(644,6,707);
-- insert into cmt_rep(ctno,mno,rwno) values(656,8,708);
-- insert into cmt_rep(ctno,mno,rwno) values(657,9,709);
