-- 1. MEMB
insert into memb(mno,email,name,pwd,path,lst_date) values(1,'admin@test.com','운영자',password('111111'),'admin.jpg','2017-03-25 18:09:12');
insert into memb(mno,email,name,pwd,path,lst_date) values(2,'user01@test.com','호호아줌마',password('111111'),'user01.jpg','2017-03-04 23:51:48');
insert into memb(mno,email,name,pwd,path,lst_date) values(3,'user02@test.com','몸살쟁이',password('111111'),'user02.jpg','2017-02-15 21:47:12');
insert into memb(mno,email,name,pwd,path,lst_date) values(4,'user03@test.com','강냉이',password('111111'),'user03.jpg','2017-03-15 14:56:22');
insert into memb(mno,email,name,pwd,path,lst_date) values(5,'user04@test.com','baobabChoi',password('111111'),'user04.jpg','2017-03-11 16:35:32');
insert into memb(mno,email,name,pwd,path,lst_date) values(6,'user05@test.com','안간다이제퉤',password('111111'),'user05.jpg','2017-03-18 18:25:44');
insert into memb(mno,email,name,pwd,path,lst_date) values(7,'user06@test.com','이뿌뿌뿌',password('111111'),'user06.jpg','2017-02-27 22:23:19');
insert into memb(mno,email,name,pwd,path,lst_date) values(8,'user07@test.com','사오정',password('111111'),'user07.jpg','2017-03-06 08:49:28');
insert into memb(mno,email,name,pwd,path,lst_date) values(9,'user08@test.com','superlovely',password('111111'),'user08.jpg','2017-03-15 17:05:39');
insert into memb(mno,email,name,pwd,path,lst_date) values(10,'user10@test.com','팽귄맨',password('111111'),'user09.jpg','2017-03-11 14:35:27');
insert into memb(mno,email,name,pwd,path,lst_date) values(11,'user11@test.com','아라샤',password('111111'),'user10.jpg','2017-02-04 20:07:46');
insert into memb(mno,email,name,pwd,path,lst_date) values(12,'user12@test.com','하양이',password('111111'),'user11.jpg','2017-01-02 06:24:41');
insert into memb(mno,email,name,pwd,path,lst_date) values(13,'user13@test.com','redblood',password('111111'),'user12.jpg','2016-12-20 23:08:16');
insert into memb(mno,email,name,pwd,path,lst_date) values(14,'user14@test.com','곰돌이푸우',password('111111'),'user13.jpg','2016-12-26 17:01:29');

-- 2. USER
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(1,'1984-09-02','01052247841','세종특별자치시 세종로 1234-8 (아름동)','온드림프라자 405호','30100','컴퓨터/인터넷','w','0','2015-09-02');
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(2,'1989-05-23','01054895547','대전광역시 동구 대성2길 101','동성빌라 201호','34599','서비스업','m','0','2017-02-08');
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(3,'1992-10-15','01088951234','부산광역시 북구 만덕대로15번길 44 (덕천동, 은호아파트)','507동 1004호','46547','유통업','m','0','2016-04-13');
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(4,'1988-04-09','01024696988','서울특별시 강동구 천중로 253 (길동, 신동아아파트)','1101동 607호','05300','교육','w','0','2016-11-24');
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(5,'1986-03-20','01016945124','경기도 안산시 단원구 와동로3길 43 (와동, 영 하이츠빌)','하이츠빌 505호','15254','의료','m','0','2016-09-28');
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(6,'1978-11-04','01045121104','경기도 과천시 관문로 128','1011동 806호','13804','예술','w','0','2015-12-17');
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(7,'1990-12-27','01033245831','서울특별시 강북구 삼각산로 47','105동 503호','01021','공무원','w','0','2015-08-06');
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(8,'1987-10-16','01010542677','서울특별시 영등포구 국회대로72길 5 (여의도동)','1514호','07238','언론','m','0','2015-06-19');
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(9,'1980-07-28','01094850704','서울특별시 성동구 독서당로 343 (금호동1가, 금호 삼성래미안 아파트)','102동 1408호','04718','금융/증권/보험업','w','0','2016-07-04');
insert into user(uno,b_day,tel,bas_adr,det_adr,zip,job,gen,out_type,join_date) values(10,'1983-02-07','01015986363','충청북도 청주시 청원구 사뜸로 44 (율량동, 통일신세대아파트)','107동 1207호','28349','군인','m','0','2015-11-30');
insert into user(uno,b_day,tel,out_type,join_date) values(11,'1990-05-11','01085441543','0','2016-04-24');
insert into user(uno,b_day,tel,out_type,join_date) values(12,'1988-06-23','01045221582','0','2016-01-03');
insert into user(uno,b_day,tel,out_type,join_date) values(13,'1979-11-25','01041395498','0','2015-12-16');
insert into user(uno,b_day,tel,out_type,join_date) values(14,'1975-09-27','01054471002','0','2016-02-14');
...
insert into comp(cpno,cp_name,parno,lvl) 
    values(599,'CJ',599,0);
insert into comp(cpno,cp_name,parno,lvl) 
    values(600,'CJ제일제당',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(601,'CJ푸드빌',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(602,'CJ프레시웨이',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(603,'CJ제일제당',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(604,'CJ E&M',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(605,'CJ CGV',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(606,'CJ헬로비전',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(607,'CJ파워캐스트',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(608,'CJ오쇼핑',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(609,'CJ대한통운',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(610,'CJ올리브네트웍스',599,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(611,'CJ건설',599,1);
-- 한국야쿠르트
insert into comp(cpno,cp_name,parno,lvl) 
    values(612,'한국야쿠르트',612,0);
insert into comp(cpno,cp_name,parno,lvl) 
    values(613,'비락',612,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(614,'팔도',612,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(615,'능률교육',612,1);
-- 삼양
insert into comp(cpno,cp_name,parno,lvl) 
    values(616,'삼양홀딩스',616,0);
insert into comp(cpno,cp_name,parno,lvl) 
    values(617,'삼양사',616,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(618,'삼양바이오팜',616,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(619,'삼양에프앤비',616,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(620,'삼양이노켐',616,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(621,'삼양화성',616,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(622,'삼남석유화학',616,1);
-- 하이트진로
insert into comp(cpno,cp_name,parno,lvl) 
    values(623,'하이트진로',623,0);
insert into comp(cpno,cp_name,parno,lvl) 
    values(624,'하이트',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(625,'맥스',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(626,'드라이피니시D',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(627,'스타우트',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(628,'망고링고',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(629,'참이슬',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(630,'자몽에이슬',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(631,'매화수',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(632,'킹덤',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(633,'석수',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(634,'토닉워터',623,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(635,'퓨리스',623,1);
-- 오비맥주
insert into comp(cpno,cp_name,parno,lvl) 
    values(636,'오비맥주',636,0);
insert into comp(cpno,cp_name,parno,lvl) 
    values(637,'카스',636,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(638,'카프리',636,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(639,'버드와이저',636,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(640,'프리미엄OB',636,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(641,'호거든',636,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(642,'코로나',636,1);
insert into comp(cpno,cp_name,parno,lvl) 
    values(643,'산토리',636,1);
insert into comp(cpno,cp_name,parno,lvl) 
